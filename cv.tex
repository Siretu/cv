...
& \IfEqCase{\longdesc}{
	...
	{false}{\begin{itemize}
			\item \small{Created a new message hub for Spotify's data infrastructure, handling billions of \mbox{messages} per hour.}
			\item \small{Optimized the system to take 15 minutes per chunk, down from 1.5 hours with Spotify's old implementation. }
		\end{itemize}}
}
\\
...
\titlespacing{\section}{0pt}{-15pt}{0pt} % Pull Projects closer
...
\textbf{\href{https://betafamily.com/webrecorder/demo}{SuperWebRecorder}} & \IfEqCase{\longdesc}{
	...
	\begin{itemize}
		...
		\item Serialized webpage DOM state as a JSON object and sent to database to be replayed later.
	\end{itemize}
	}}
}
	  \\
